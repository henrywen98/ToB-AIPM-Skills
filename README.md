...
# 2a. 安装 PM 工作流 skill 集合（10 个 skill 一次到位）
/plugin install tob-aipm-skills@tob-aipm

# 2b. 或者只装 code-to-prd（独立工具，反向出 PRD）
/plugin install code-to-prd@tob-aipm
```
...
| Plugin | 说明 | License |
|---|---|---|
| [`tob-aipm-skills`](./plugins/tob-aipm-skills) | ToB PM 工作流 skill 集合：epic-prd / feature-prd / feature-spec / feature-us / phase-plan / phase-confirm-doc / test-scenarios / dummy-dataset / md-to-docx / brainstorming | MIT |
| [`code-to-prd`](./plugins/code-to-prd) | 从现有代码库逆向生成完整 PRD（前端 + 后端 + 全栈） | MIT |
...
- `plugins/tob-aipm-skills/LICENSE`：合并 MIT 通知（henrywen98 + Pawel Huryn + Jesse Vincent）
- `plugins/code-to-prd/LICENSE`：上游 MIT 原文（© 2025 Alireza Rezvani）
